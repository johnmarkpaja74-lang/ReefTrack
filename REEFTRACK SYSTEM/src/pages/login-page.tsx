...
export function LoginPage() {
  ...
  const draft = useMemo(() => getLoginDraft(), [])
  ...
  const [remember, setRemember] = useState(hasRememberedLogin())
  const [showPassword, setShowPassword] = useState(false)
  const [recoveryOpen, setRecoveryOpen] = useState(searchParams.get("forgot") === "1")
  const [notice, setNotice] = useState<Notice>(() => searchParams.get("created") === "confirmation"
